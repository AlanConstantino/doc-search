...
from ..index.store import BM25Index
from ..core.text import tokenize, tokenize_phrase
from .features.spellcheck import SpellChecker
from .features.facets import FacetIndex
from .features.synonyms import SynonymExpander
from .features.symspell import SymSpell
from .features.ngram import NGramIndex
from .features.reranker import Reranker, RerankConfig, RerankMetrics
from .snippets import (
    highlight_terms, find_best_snippet,
    check_phrase_match, normalize_document_text,
)
...
class SearchEngine:
    ...
    def load(
        ...
        if clicks_db.exists():
            try:
                from .features.clicks import ClickLog
    ...
    def _load_page_text(self, url: str) -> Optional[str]:
        ...
        if self.pages_dir:
            from ..core.urls import url_to_filename
    ...
    def _make_snippet(
        ...
        *,
        ...
        try:
            from ..core.constants import MAX_SNIPPET_LENGTH
...
class EnhancedSearchEngine(SearchEngine):
    ...
    def _load_content_suggester(self):
        ...
        for candidate in [parent / 'suggestions.json.gz', parent / 'suggestions.json']:
            if candidate.exists():
                try:
                    from .features.suggester import ContentSuggester
    ...
    def _build_term_weights(
        ...
        for term in expanded_terms:
            ...
            if term_lower in synonym_terms:
