...
from ...index import BM25Index, find_index_path
from ...search.engine import SearchEngine, EnhancedSearchEngine, parse_query
from .formatters import format_results
from ...core.urls import site_hash
from ...core.text import format_size, format_duration
from ..terminal import (
    Colors, style_success, style_error, style_info, style_title, style_url,
    emoji as _e,
)
from ...core.config import get_sites_dir, get_loaded_config_path, apply_runtime_config, reload_config
...
def cmd_index(args):
    ...
    if no_symspell:
        ...
        from ...search.features.side_indexes import build_symspell
        symspell = build_symspell(index, max_distance=2)
    ...
    if no_ngram:
        ...
        from ...search.features.side_indexes import build_ngram_index
        ngram_index = build_ngram_index(index, n=3)
...
def cmd_search(args):
    ...
    if synonyms_file:
        try:
            from ...search.features.synonyms import load_synonyms_file
...
def cmd_interactive(args):
    ...
    from ..terminal import _resolve_styles, colorize
...
def cmd_stats(args):
    ...
    from ...crawl.state import CrawlState
...
def cmd_index_files(args):
    ...
    from ...extract import ExcelExtractor, WordExtractor, PDFExtractor, PPTXExtractor
    import hashlib
    ...
    for file_path in files_to_process:
        ...
        try:
            if ext == '.xlsx':
                ...
                from ...extract.html import extract_text as extract_html
                try:
...
def cmd_search_all(args):
    ...
    from ...search.multi import MultiSiteSearchEngine
